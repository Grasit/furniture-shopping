...
const Profile =() => {
    return (
        <div className="font-primary text-primary space-y-4 p-4">
            <NetworkBar/>
            ...
            <div className=" flex justify-between p-4 shadow-[0px_7px_40px_rgba(138,149,158,0.2)] h-20">
                <div>
                    <p className="text-lg font-bold text-primary">My Orders</p>
            ...
            <div className=" flex justify-between p-4 shadow-[0px_7px_40px_rgba(138,149,158,0.2)] h-20">
                <div>
                    <p className="text-lg font-bold text-primary">Shipping Addresses</p>
            ...
            <div className=" flex justify-between p-4 shadow-[0px_7px_40px_rgba(138,149,158,0.2)] h-20">
                <div>
                    <p className="text-lg font-bold text-primary">Payment Method</p>
            ...
            <div className=" flex justify-between p-4 shadow-[0px_7px_40px_rgba(138,149,158,0.2)] h-20">
                <div>
                    <p className="text-lg font-bold text-primary">My Reviews</p>
            ...
            <div className=" flex justify-between p-4 shadow-[0px_7px_40px_rgba(138,149,158,0.2)] h-20">
                <div>
                    <p className="text-lg font-bold text-primary">Settings</p>
